...
```{r}
expect_error(ExampleClass(rowVec=1))
expect_error(ExampleClass(colVec=1))
expect_error(ExampleClass(rowToRowMat=rbind(1)))
expect_error(ExampleClass(colToColMat=rbind(1)))
expect_error(ExampleClass(rowToColMat=rbind(1)))
expect_error(ExampleClass(colToRowMat=rbind(1)))
```
