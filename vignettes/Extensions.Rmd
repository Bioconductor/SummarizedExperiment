...
The final step is to define a validity method that enforces the constraints that we described earlier.
...
Testing out the constructor yields the expected output when counts are provided:
